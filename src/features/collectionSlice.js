...
export const menProduct = createAsyncThunk("product/menProduct", async () => {
  return fetch(
    "https://limitless-everglades-36569.herokuapp.com/MenProduct"
  ).then((res) => res.json());
});
...
export const womenProduct = createAsyncThunk(
  ...
  async () => {
    return fetch(
      "https://limitless-everglades-36569.herokuapp.com/WomenProduct"
    ).then((res) => res.json());
  }
);
...
export const kidProduct = createAsyncThunk("product/kidProduct", async () => {
  return fetch(
    "https://limitless-everglades-36569.herokuapp.com/kidProduct"
  ).then((res) => res.json());
});
