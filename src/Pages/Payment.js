...
const Payment = () => {
  ...
  if (transactionId) {
    ...
    fetch(`https://limitless-everglades-36569.herokuapp.com/removeFromCart/${user?.email}`, {
      method: "DELETE",
      headers: { "Content-type": "application/json" },
    })
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch("https://limitless-everglades-36569.herokuapp.com/create_payment_intent", {
      method: "POST",
      headers: {
