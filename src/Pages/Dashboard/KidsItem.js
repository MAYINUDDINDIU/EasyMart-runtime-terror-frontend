...
const KidsItem = () => {
    ...
    return (
        <div>
            <h1 className='text-4xl text-teal-700 font-bold my-4'>Add Products For Kid's</h1>
            <form onSubmit={handleSubmit} className='flex flex-col items-center mx-auto gap-2 mt-4'>
                <input type="text" name='kids' value='kids' disabled className="input input-bordered text-center font-bold text-3xl input-info w-full max-w-xs" />
