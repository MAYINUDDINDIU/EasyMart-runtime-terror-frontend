...
const KidsItem = () => {
    ...
    return (
        <div>
            <h1 className='text-4xl text-orange-500 font-bold'>Add Products For Kid's</h1>
            <form onSubmit={handleSubmit} className='flex flex-col w-48 mx-auto gap-2 mt-4'>
                <div className="form-control">
                    <label className="input-group input-group-lg">
                        <span>Kids</span>
                        <input type="text" name='kids' value='kids' disabled className="input input-bordered input-group-lg" />
                    </label>
                </div>
                <div className="form-control">
                    <label className="input-group input-group-lg">
